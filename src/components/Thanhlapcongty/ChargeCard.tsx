    ...
    <div id='charge' className='wrap-break-word'>
      ...
      >
        <Grid size={{ xs: 12, md: 3 }}>
          <div className='w-full h-full shadow-[0_0_20px_rgba(0,0,0,0.3)] rounded-2xl '>
            <h2 className='text-gray-400 text-2xl md:text-3xl text-center py-2'>
              Gói cơ bản
              <br />0 VNĐ
            </h2>
            ...
            <div className='p-4 text-lg'>
              <ul className=''>
                <li>
                  <span className=' mr-2'>
                    <CheckCircle fontSize='small' sx={{ color: '#00b300', marginBottom: '3px' }} />
                  </span>
        ...
        <Grid size={{ xs: 12, md: 3 }}>
          <div className='w-full h-full shadow-[0_0_20px_rgba(0,200,255,1)] rounded-2xl'>
            <h2 className='text-2xl md:text-3xl text-center py-2 text-[rgba(0,200,255,1)]'>
              Gói nâng cao
              <br />0 VNĐ
            </h2>
            ...
            <div className='p-4 text-lg'>
              <ul className=''>
                <div className='text-center mb-2 text-[rgba(0,200,255,1)] '>Bao gồm gói cơ bản</div>
                <li>
                  <span className=' mr-2'>
                    <CheckCircle fontSize='small' sx={{ color: '#00b300', marginBottom: '3px' }} />
                  </span>
        ...
        <Grid size={{ xs: 12, md: 3 }}>
          <div className='w-full h-full shadow-[0_0_20px_rgba(255,140,6,1)] rounded-2xl'>
            <h2 className='text-2xl md:text-3xl text-center py-2 text-[rgba(255,140,6,1)]'>
              Gói toàn diện
              <br />0 VNĐ
            </h2>
            ...
            <div className='p-4 text-lg'>
              <ul className=''>
                <div className='mb-2 text-center text-[rgba(255,140,6,1)] '>Bao gồm gói nâng cao</div>
                <li>
                  <span className=' mr-2'>
                    <CheckCircle fontSize='small' sx={{ color: '#00b300', marginBottom: '3px' }} />
                  </span>
                ...
                <div className='text-[rgba(255,140,6,1)] '>Đặc quyền VIP:</div>
                <li>
                  <span className=' mr-2'>
                    <CheckCircle fontSize='small' sx={{ color: '#00b300', marginBottom: '3px' }} />
                  </span>
